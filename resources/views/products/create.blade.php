            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-2xl">
                    ...
                    <x-form action="{{ route('products.store') }}" method="POST" class="mt-6 space-y-3">
                        ...
                        <x-textarea id="description" rows="4" name="description">{{ old('description') }}</x-textarea>
