<x-app-layout>
    @section('page.title','Редактирование нормы продукции')
            ...
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <div class="max-w-2xl">
                    ...
                    <x-form action="{{ route('product-norms.update',$norm->id) }}" method="PUT" class="mt-6 space-y-3">
                        ...
                        <x-text-input id="norm" class="block mt-1 w-full" type="text" name="norm" :value="old('norm',$norm->norm)" />
